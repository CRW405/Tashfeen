...
\begin{sol}
  Because if $(X^T)^{-1}$ exists then your algorithm is too bad to bother with
\end{sol}
...
\begin{sol}
  \begin{figure}
    \includegraphics{../machine learning/ml4/bestfit.png}
  \end{figure}
\end{sol}
...
\begin{sol}
  I have no way of knowing the intention behind the authors without them just saying it and being honest.
  Racists probably existed in the 70's so it would be a data point that would impact housing prices for racist populations.
  However, stating that black people drive down housing prices is certainly a statement.
  Furthermore, the obscuring of the raw data is incredibly suspicious and makes me lean towards them being racist.
  Either way, the data set is still useful for study, such as this question.
\end{sol}
...
\begin{sol}
  \begin{figure}
    \includegraphics{../machine learning/ml4/rm.png}
  \end{figure}
\end{sol}
...
\begin{sol}
  \begin{figure}
    \includegraphics{../machine learning/ml4/lstat.png}
  \end{figure}
\end{sol}
        \end{sol}
