...
\begin{sol}
	\begin{figure}
		\includegraphics[width=\linewidth]{../machine learning/ml6/Figure_1.png}
	\end{figure}
\end{sol}
...
\begin{sol}
    \begin{enumerate}
        \item because there are 10 digits, 0,1...8,9
        \item n = 10000, p = 28 * 28 = 784
        \item light level of a pixel
        \item They are a lot of different numbers written in different ways are averaged together so the results only show a heat map of the most common drawn places
    \end{enumerate}
\end{sol}

\begin{sol}
	\begin{figure}
		\includegraphics[width=\linewidth]{../machine learning/ml6/Figure_2.png}
	\end{figure}
\end{sol}
