...
\class{CSCI 2114: tashfeenn's Data Structures}
\date{\today}
\title{Homework 4}
\address{%
...
\texttt{plot\_l7ist.py} (make sure you set the appropriate
...
\begin{sol}
  \img<img>[0.65]{}{../Data Structures/hm4/given/plot.png}
Confirms. Any variances can be explained by Java garbage collection.
\end{sol}
...
\begin{enumerate}
  ...
  \item Use your queue implementation to draw the
        ...
        \begin{sol}
          \img<img>[0.65]{}{~/Pictures/Screenshots/Screenshot_03-Oct_12-19-13_1096.png}
        \end{sol}
\end{enumerate}
...
\begin{sol}
  \img<img>[0.65]{}{~/Pictures/Screenshots/Screenshot_03-Oct_13-52-12_27508.png}
\end{sol}
