...
\begin{sol}
  still 5 since everything is scaled equally
\end{sol}
...
\begin{sol}
  \begin{enumerate}
    \item 1, but python says 0.999999999999999
    \item 0
    \item 1
    \item a floating point error means that $(1-.55)/.45=0.99999999999$ which means that 1 is the max arg in this system
  \end{enumerate}
\end{sol}
...
\begin{enumerate}
  \item Looking at the columns, pick four that you think will be the
        ...
        \begin{sol}
          All you really need is just survival, body, or boat.

          but if you couldnt choose those, then you could choose sex, age, sibsp, and parch
        \end{sol}
...
women:  358 
women survived:  267 
men\%:  11.64021164021164 
women\%:  28.253968253968253
        \end{sol}
  \item Finish the
